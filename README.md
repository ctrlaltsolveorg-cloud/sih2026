...
[![Languages](https://img.shields.io/badge/Vernacular%20Support-11%20Indian%20Languages-D97706?style=for-the-badge&logo=google-translate&logoColor=white)](#-11-languages)
[![License](https://img.shields.io/badge/License-MIT-emerald?style=for-the-badge)](LICENSE)

[🌐 Explore Live Production App](https://sih2026-smoky.vercel.app) • [📹 Watch Demo](https://sih2026-smoky.vercel.app) • [📖 Architecture](#-system-architecture) • [🚀 Quickstart](#-getting-started)
...
In a nation where over **140 million families depend on agriculture**, our अन्नदाता (food providers) often wake up at 3:00 AM, load their harvest onto bullock carts or shared trucks, and travel dozens of kilometers to local mandis — only to face:
- **Predatory Middlemen Commissions (up to 30-45%):** Farmers take the production risks, yet brokers capture the bulk of the margin.
- **Subjective Quality Deductions:** Produce is downgraded arbitrarily by eye, leaving farmers with pennies on the rupee.
- **The Smartphone Barrier:** Over **60% of marginalized smallholders** still use basic feature phones without reliable 4G data.
- **Language & Dialect Gaps:** A farmer writing *"baigan"*, *"began"*, or speaking in their mother tongue is excluded by rigid English-only software.

> **Our Mission:**  
> **KisanBandhan AI** connects the soil of Bharat directly with institutional bulk buyers, food processors, and conscious consumers. We replace middlemen with mathematical fairness, computer vision quality verification, and multimodal vernacular accessibility.

---

## ✨ Core Pillars: What Makes KisanBandhan Human & Smart
...
### 2. 👁️ Computer Vision Quality Grading
...
- **Phonetic Dialect & Typo Matcher:** Understands regional accents and spelling mistakes:
  - `"baigan"`, `"began"`, `"bagan"`, `"baingan"` ➡️ Automatically recognized as **`बैंगन` (Eggplant / Brinjal)** with 98% confidence.
  - `"tmatar"`, `"tamater"` ➡️ Auto-resolved to **`टमाटर` (Fresh Tomatoes)**.
  - Zero cognitive barrier for rural users.

### 5. 📞 1800-KISAN-AI: Feature-Phone Keypad IVR
- No smartphone? No problem.
- Farmers can simply dial **1800-KISAN-AI** from any basic ₹800 keypad phone, press `1` for Tomato, `2` for Onion, speak their quantity, and receive an instant SMS contract confirmation.

### 6. 🛡️ Strict Role Isolation & Escrow Security
...
| **🏛️ Mandi Governance** | [`/admin`](https://sih2026-smoky.vercel.app/admin) | National MSP enforcement, real-time APMC price ticker, grievance redressal. |
...
flowchart TD
    ...
    subgraph Intelligence["2. Intelligent Processing Core"]
        B1["🌾 Fair Price AI (Agmarknet + MSP)"]
        B2["👁️ Computer Vision Grading Engine"]
        B3["🧠 Probabilistic & Phonetic Fuzzy Matcher"]
        B4["📦 FPO Virtual Lot Aggregator"]
    end

    subgraph Security["3. Security & Governance"]
        C1["🛡️ PortalGuard Role-Based Access Control"]
        C2["🔐 Smart Escrow Payment Vault"]
        C3["🔑 Transporter OTP & Hub QR Verification"]
    end

    subgraph Storage["4. Hybrid Ledger Storage"]
        D1["🗄️ PostgreSQL / Supabase (Distributed Production)"]
        D2["💾 High-Throughput SQLite WAL Engine"]
        D3["⚡ In-Memory Vector & Translation Cache"]
    end
