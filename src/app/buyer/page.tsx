      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {buyerOrders.map((ord) => (
                <div key={ord.id} className="glass-card p-5 rounded-2xl space-y-3 border border-emerald-900/10 dark:border-emerald-500/20">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-mono font-bold text-emerald-800 dark:text-emerald-300">
                      {language === 'hi' ? 'ऑर्डर #' : 'Order #'}{ord.id}
                    </span>
                    <span className="text-[10px] px-2.5 py-0.5 bg-emerald-900 dark:bg-emerald-800 text-amber-200 font-bold rounded-full border border-emerald-700/50">
                  ...
                  <h3 className="font-extrabold text-base text-emerald-950 dark:text-emerald-50">
                    {language === 'hi' ? 'किसान: ' : 'Farmer: '}{getLocalizedFarmer(ord.farmer_name, language)}
                  </h3>
                  <p className="text-xs text-emerald-800/80 dark:text-emerald-200 flex items-center gap-1">
                  ...
                  <div className="pt-3 border-t border-emerald-900/10 dark:border-emerald-500/20 flex items-center justify-between">
                    ...
                    <span className="text-xs font-bold text-emerald-700 dark:text-emerald-100 bg-emerald-50 dark:bg-emerald-900/80 dark:border dark:border-emerald-500/30 px-2.5 py-1 rounded-lg">
