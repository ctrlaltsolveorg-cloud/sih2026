...
export default function Navbar({ onOpenCart }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 w-full backdrop-blur-2xl backdrop-saturate-200 bg-[#FAF5EB]/75 dark:bg-[#07170f]/80 border-b border-emerald-900/15 dark:border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.05)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all duration-200 relative">
      {/* Blurred colored background ambient glow lights contained inside their own overflow-hidden wrapper */}
